...
<body>
    <div class="modal-content">
        <h1>Edit Patron</h1>
        <form  id="addPatronForm" action="<%= request.getContextPath() %>/views/admin/patron/process_editPatron.jsp" method="POST">
            ...
            <div class="form-actions">
                ...
                <button type="button" class="cancel-btn"onclick="window.location.href='<%= request.getContextPath() %>/views/admin/patron/patron.jsp'">Cancel</button>
            </div>
        </form>
    </div>
    <style>
