...
<body>
    <div class="modal-content">
        ...
        <% if (session.getAttribute("error_message") != null) { %>
            ...
            %>
        <% } %>
        <form id="addUserForm" action="<%= request.getContextPath() %>/views/admin/visitors/process_editVisitor.jsp" method="POST">
            ...
            <div class="form-actions">
                ...
                <button type="button" class="cancel-btn" onclick="window.location.href='<%= request.getContextPath() %>/views/admin/visitors/visitor.jsp'">Cancel</button>
            </div>
        </form>
    </div>
    <style>
