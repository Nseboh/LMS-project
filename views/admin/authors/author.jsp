    ...
    <div class="container">
        ...
        <div class="sidebar" style="background-color: #070D59;">
            ...
            <nav class="sidebar-nav">
                <div class="nav-item" onclick="window.location.href='<%= request.getContextPath() %>/views/admin/patron/patron.jsp'" style="color: #ffffff;">
                ...
                <div class="nav-item" onclick="window.location.href='<%= request.getContextPath() %>/views/admin/books/books.jsp'" style="color: #ffffff;">
                    <i class="fas fa-book" style="color: #ffffff;"></i>
                    <span style="color: #ffffff;">Books</span>
                </div>
                <div class="nav-item" onclick="window.location.href='<%= request.getContextPath() %>/views/admin/visitors/visitor.jsp'" style="color: #ffffff;">
                    <i class="fas fa-walking" style="color: #ffffff;"></i>
                    <span style="color: #ffffff;">Visitors</span>
                </div>
                <div class="nav-item" onclick="window.location.href='<%= request.getContextPath() %>/views/admin/records/record.jsp'" style="color: #ffffff;">
                    <i class="fas fa-clipboard-list" style="color: #ffffff;"></i>
                    <span style="color: #ffffff;">Records</span>
                </div>
                <div class="nav-item" onclick="window.location.href='<%= request.getContextPath() %>/views/admin/attendance/attendance.jsp'" style="color: #ffffff;">
                    <i class="fas fa-calendar-check" style="color: #ffffff;"></i>
                    <span style="color: #ffffff;">Attendance</span>
                </div>
                <div class="nav-item" onclick="window.location.href='<%= request.getContextPath() %>/views/admin/publishers/publisher.jsp'" style="color: #ffffff;">
                    <i class="fas fa-building" style="color: #ffffff;"></i>
                    <span style="color: #ffffff;">Publishers</span>
                </div>
                <div class="nav-item" onclick="window.location.href='<%= request.getContextPath() %>/views/admin/issuedBooks/lending.jsp'" style="color: #ffffff;">
