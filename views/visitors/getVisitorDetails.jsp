...
<%
    ...
    try {
        ...
        String sql = "SELECT first_name, last_name, contact_number, email, gender, status, time_out FROM visitor WHERE visitor_id = ?";
        ...
        if (rs.next()) {
            jsonResponse = String.format(
                "{\"firstName\":\"%s\", \"lastName\":\"%s\", \"contactNumber\":\"%s\", \"email\":\"%s\", \"gender\":\"%s\", \"status\":\"%s\", \"timeOut\":\"%s\"}",
